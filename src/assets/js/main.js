jQuery(function ($) {
	...
	// Scroll suave solo para CTA del banner (enlaces del navbar los maneja Angular con scrollIntoView)
	$('.main-banner-content .default-btn[href^="#"]').on('click', function(e){
		var anchor = $(this);
